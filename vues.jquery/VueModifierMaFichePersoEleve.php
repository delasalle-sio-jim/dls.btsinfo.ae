	...
	<body>
		<div data-role="page" id="page_principale">
			...
			<div data-role="content">
				<h4 style="text-align: center; margin-top: 10px; margin-bottom: 10px;">Modifier les informations de votre compte</h4>
						<form name="form1" id="form1" action="index.php?action=ModifFichePerso" method="post" data-ajax="false">
