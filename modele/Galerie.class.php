...
// fichier : modele/Galerie.class.php
// Rôle : la classe Galerie représente les photos de la galerie des anciens 
...
class Galerie
{
	...
	public function Galerie($unId, $unePromo, $uneClasse, $unLien) {
		$this->id = $unId;
		$this->promo = $unePromo;
