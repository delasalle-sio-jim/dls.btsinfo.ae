...
// Fonction du contrôleur CtrlModifUserAdmin.php : traiter la modification d'un compte d'un élève par un administrateur
...
if( (! isset ($_POST ["listeEleves"]) == true) && ( ! isset ($_POST ["btnModifier"]) == true)){
	// redirection vers la vue si aucune données n'est recu par le controleur
		...
		include_once ($cheminDesVues . 'VueRemboursement.php');
	}
