	...
	<div id="page">
		...
		<div id="header">
			<div id="header-menu">
				<ul id="menu-horizontal">
					<li><a href="index2.php">Retour au portail</a></li>
				</ul>
			</div>
			<div id="header-logos">
		...
		<div id="content">
			...
			<div id="pages">
				...
				<p><a href="documents/infos_tuteur_stage_SIO1.doc" class="petit-bouton-menu">Informations pour le maître de stage SIO1 (format Word)</a></p>
				<p><a href="documents/CR_Prenom_Nom_semaine_X.docx" class="petit-bouton-menu">Compte rendu hebdomadaire du stagiaire (format Word)</a></p>
				<p><a href="documents/AttestationDeStage2016.docx" class="petit-bouton-menu">Attestation de stage SIO1 pour 2016 (format Word)</a></p>
			</div>

			<h2>Documents destinés aux stagiaires SIO2</h2>
			<div id="pages">
				<p><a href="documents/consignes_etudiants_stage_SIO1.docx" class="petit-bouton-menu">Consignes aux étudiants pour le stage SIO2 (format Word)</a></p>
				<p><a href="documents/infos_tuteur_stage_SIO2.doc" class="petit-bouton-menu">Informations pour le maître de stage SIO2 (format Word)</a></p>
				<p><a href="documents/CR_Prenom_Nom_semaine_X.docx" class="petit-bouton-menu">Compte rendu hebdomadaire du stagiaire (format Word)</a></p>
				<p><a href="documents/AttestationDeStage2016.docx" class="petit-bouton-menu">Attestation de stage SIO2 pour 2016 (format Word)</a></p>
			</div>
